...
//        UncertainItemset item4 = new UncertainItemset<>(3, 0.3);
        ...
        UncertainItemset<String> item5 = new UncertainItemset<>("A", 0.1);
        UncertainItemset<String> item6 = new UncertainItemset<>("D", 0.3);
        ...
        UncertainTransaction transaction3
                = new UncertainTransaction(2, new ArrayList<>(Arrays.asList(item5)));
        //create uncertain database
