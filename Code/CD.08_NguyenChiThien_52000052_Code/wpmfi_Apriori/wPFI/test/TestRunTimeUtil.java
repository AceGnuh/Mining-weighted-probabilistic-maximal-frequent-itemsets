...
public class TestRunTimeUtil {
     ...
     */
    public static int[][] getRunTimeList(String nameDataset, String nameWeighted, double[] minSupportList, double[] minConfidence, double scaleFactor, boolean isProbabilityModel){
