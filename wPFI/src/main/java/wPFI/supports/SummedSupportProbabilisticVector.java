...
public class SummedSupportProbabilisticVector <E>{
    ...
    public SummedSupportProbabilisticVector(UncertainDatabase<E> uncertainDatabase, Set<E> inputItemset) {
     ...
     */
    private double[] DC(List<UncertainTransaction<E>> transactions, Set<E> pattern) {
